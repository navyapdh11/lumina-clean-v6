...
const testimonials = [
  {
    ...
    rating: 5,
    text: 'PerthClean transformed our home! The AR room scanner gave us an instant quote, and the team arrived the same day. Absolutely phenomenal service - worth every penny!',
  ...
  },
  {
    ...
    rating: 5,
    text: 'We manage 15 office buildings and PerthClean handles them all flawlessly. Their commercial team is professional, reliable, and the pricing is transparent. Highly recommend!',
  ...
  },
  {
    ...
    rating: 5,
    text: 'As an NDIS participant, finding reliable cleaning support was stressful until I found PerthClean. Their team understands my needs and always treats my home with respect.',
  ...
  },
  {
    ...
    rating: 5,
    text: 'Our 120-lot strata scheme has never looked better. PerthClean\'s dedicated account manager understands our unique needs and the quality is consistently excellent.',
  ...
  },
  {
    ...
    rating: 5,
    text: 'We use PerthClean for all our pre-sale cleans. Properties sell faster when they look spotless. Their team understands the urgency and delivers every single time.',
